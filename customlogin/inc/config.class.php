...
class PluginCustomloginConfig extends CommonDBTM
{
    ...
    public function show()
    {
        ...
        if (!empty($fields['logo'])) {
            ...
            echo '</td>';
        } else if (!empty($fields['background']) || !empty($fields['main_background'])) {
            echo '<td></td>';
        }
        ...
        // BACKGROUND
        echo "<tr class=\"tab_bg_1\"><td>Background Front</td>";
        if (!empty($fields['background'])) {
            ...
            echo '</td>';
        } else if (!empty($fields['logo']) || !empty($fields['main_background'])) {
            echo '<td></td>';
        }
        ...
        // MAIN BACKGROUND
        echo "<tr class=\"tab_bg_1\"><td>Background Bottom</td>";
        if (!empty($fields['main_background'])) {
            ...
            echo '</td>';
        } else if (!empty($fields['logo']) || !empty($fields['background'])) {
            echo '<td></td>';
        }
